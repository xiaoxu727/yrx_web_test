...
(function() {
    ...
    var _$is_temp = window._$is
    Object.defineProperty(window, '_$is', {
        get: function() {
            console.log(_$is_temp);
            return _$is_temp;
        },
        set: function(val) {
            // debugger;
    ...
    var _$qF_temp = window._$is
    Object.defineProperty(window, '_$qF', {
        get: function() {
            console.log(_$qF_temp);
            return _$qF_temp;
        },
        set: function(val) {
            // debugger;
    ...
    var _$pr_temp = window._$is
    Object.defineProperty(window, '_$pr', {
        get: function() {
            console.log(_$pr_temp);
            return _$pr_temp;
        },
        set: function(val) {
            // debugger;
    ...
    var _$ss_temp = window._$ss
    Object.defineProperty(window, '_$ss', {
        get: function() {
            console.log(_$ss_temp);
            return _$ss_temp;
        },
        set: function(val) {
            debugger;
    ...
    // var CryptoJS_temp = window.CryptoJS
    // Object.defineProperty(window, 'CryptoJS', {
    //     get: function() {
    //         console.log(CryptoJS_temp);
    //         return CryptoJS_temp;
    //     },
    //     set: function(val) {
    //         // debugger;
    //         CryptoJS_temp = val
    //
    //         //  Object.defineProperty(window.CryptoJS, 'AES', {
    //         //     get: function() {
    //         //         console.log(CryptoJS_temp);
    //         //         return window.CryptoJS.AES;
    //         //     },
    //         //     set: function(val) {
    //         //         debugger;
    //         //         window.CryptoJS.AES = val
    //         //     },
    //         // });
    //
    //         // Object.defineProperty(window.CryptoJS.lib, 'BlockCipher', {
    //         //     get: function() {
    //         //         // console.log(CryptoJS_temp);
    //         //         return window.CryptoJS.lib.BlockCipher;
    //         //     },
    //         //     set: function(val) {
    //         //         debugger;
    //         //         window.CryptoJS.lib.BlockCipher = val
    //         //     },
    //         // });
    //
    //     },
    ...
    // var AES_temp = window.CryptoJS.AES
